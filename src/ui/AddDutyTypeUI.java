...
public class AddDutyTypeUI extends JDialog
{
	...
	public void setDutyTypeUIComponent(Map<String, Object> dutyTypeUIComponent) {
		AddDutyTypeUI.dutyTypeUIComponent = dutyTypeUIComponent;
	}
	...
	private void initUI(JDialog owner)
	{
		...
		JPanel enterKmValue = templates.getLabelWithTextField("enterKmValue", "Enter Km.", "Enter Km Here",10,true, dutyTypeUIComponent);
		bodyLeftPanel.add(enterKmValue);
		
		JPanel enterPkgRate = templates.getLabelWithTextField("enterPkgRate", "Enter Rate", "Enter Rate Here", 10, true,dutyTypeUIComponent);
		...
		JPanel panelVehicle = templates.getLabelWithCombo("panelVehicle", "Select Vehicle	", UI_ID+reg.getValueFor("ID_VEHICLE_SELECT_DUTY_TYPE_COMBO"), SConstants.VEHICLE_TYPES, dutyTypeUIComponent);
